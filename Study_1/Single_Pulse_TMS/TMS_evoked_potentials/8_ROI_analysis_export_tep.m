...
% load file
load ([outPath 'ROI_analysis_SP_' strjoin(elec, '_') '.mat'])
...
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSlatSPSS,'Lat','B2');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RScolSPSS,'Lat','B1');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSrowSPSS,'Lat','A2');


xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSlat,'Sheet1','B2');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RScol,'Sheet1','B1');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSrow,'Sheet1','A2');


% Export amplitude into Excel File of Sheet 2

xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSamp,'Sheet2','B2');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RScol,'Sheet2','B1');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSrow,'Sheet2','A2');


% Export Averaged amplitude into Excel File of Sheet 3

xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSampAv,'Sheet3','B2');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RScol,'Sheet3','B1');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSrow,'Sheet3','A2');
...
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSampSPSS,'Sheet4','B2');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RScolSPSS,'Sheet4','B1');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSrowSPSS,'Sheet4','A2');


% Export Averaged amplitude into Excel File of Sheet 5 for SPSS

xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSampAvSPSS,'Sheet5','B2');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RScolSPSS,'Sheet5','B1');
xlswrite([outPath filesep 'TBS_ROI_' strjoin(elec, '_') '.xlsx'],RSrowSPSS,'Sheet5','A2');
