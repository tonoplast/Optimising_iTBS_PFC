...
%Condition 1
cond1 = 'PPTMS_iTBS_LICIdiff_T1'; % 
% 
% %Condition 2
cond2 = 'PPTMS_cTBS_LICIdiff_T1'; % 

% Other examples
% cond1 = 'PPTMS_iTBS_LICI_T1'; % 
% cond2 = 'PPTMS_iTBS_LICI_T0'; % 
...
save ([outPath,'stats_',cond1,'_V_',cond2,'_',FOIName], 'stat','TOI','FOI');
