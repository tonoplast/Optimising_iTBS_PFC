...
% script. This is for Paired-Pulse (PP) data.
%
% IMPORTANT!!!
...
PPinPath = 'F:\Data\EEG\0_TBS\TMS_analysis\';
...
ft_defaults;
 ...
 for z = 1:size(tp,1)
    ...
    load([PPinPath filesep ID{x,1} filesep Sesh{y,1} filesep [ID{x,1} '_' Sesh{y,1} '_'  tp{z,1} '_PP_final_corrected']], 'avgPC');
...
%set filename
filename = ['PPTMS_' Sesh{y,1} '_final_' tp{z,1} '_ft_ga'];
