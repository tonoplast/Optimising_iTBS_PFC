...
%Condition 1
cond1 = 'TMSEEG_75_final_T1';

%Condition 2
cond2 = 'TMSEEG_75_final_T0';

FOINAME = 'theta'; % 'theta'; 'alpha' ; 'beta'; 'gamma' ;
%Path
inPath =  ['F:\Data\EEG\1_Intensity\ROI\Freq_analysis\stats'];
cd(inPath);

timewin = 'all';
load([inPath,'stats_',cond1,'_V_',cond2,'_' FOIName '_' timewin '.mat']);
