...
Sesh = '100'; %50 75 100
para = 'final'; % appropriate file name

cond1 = ['TMSEEG_' Sesh '_' para '_T0']; 
cond2 = ['TMSEEG_' Sesh '_' para '_T1']; 
cond3 = ['TMSEEG_' Sesh '_' para '_T2']; 


% cond1 = ['TMSEEG_50_norm_T2']; 
% cond2 = ['TMSEEG_75_norm_T2'];
% cond3 = ['TMSEEG_100_norm_T2'];
...
P35time = [0.031 0.041]; % not used
N45time = [0.030 0.054]; 
P60time = [0.056 0.080]; 
N120time = [0.090 0.140]; 
P200time = [0.160 0.240];
...
cfg.channel     =  {'FCZ','FCZ'};  %plotting electrode
cfg.xlim = [-0.05 0.40];
if exist('cond3') == 1
...
chaninfo = D1.label';
   ...
   sqm2plotROID3 = squeeze(mean(mplotROID3,2))';
    ...
    plotROID1 = plot(D1.time(tdx1:tdx2),sqm2plotROID1,'r','LineWidth',2); 
    ...
    plotROID2 = plot(D2.time(tdx1:tdx2),sqm2plotROID2,'r','LineWidth',2); grid on; hold on;
    ...
    set(gcf, 'Position', [350 500 1200 360]);
...
if exist('cond3') == 1
D1.prediff = D2.avg - D3.avg; %%% for diff conditions 
end
...
N45_xlim = [0.030 0.055];
P60_xlim = [0.055 0.080];
N100_xlim = [0.090 0.140];
P200_xlim = [0.160 0.240];
